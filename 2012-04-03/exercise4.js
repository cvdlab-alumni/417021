...
var generatePools = function(){
	...
	var pool1 = SIMPLEX_GRID([[-1,20],[-1,9],[-0.02,1.28]]);
	var pool2 = SIMPLEX_GRID([[-47,4],[-5,11],[-0.02,1.28]]);
	return COLOR([0,1,1])(STRUCT([pool1,pool2]));
}
...
var bookCase = T([0,1,2])([25,5,1.5])(generateBookCase());
